...
<bignumber>`r prettyNum(robberies_city$yeartodate2024, big.mark=",")`<br></bignumber>
<p>Year To Date<br>Through `r format(robberies_city$lastdate, "%B %d")`</p>
</div>
<div class="card" style="background-color:#99a0a5;">
<p>Robberies Last Year<br>
<bignumber>`r prettyNum(robberies_city$yeartodate2023, big.mark=",")`<br></bignumber>
...
<br>
Robberies so far this year are trending <h8>`r ifelse(robberies_city$yeartodate_pct_change>=0," up"," down")` `r ifelse(robberies_city$yeartodate_pct_change>=0,robberies_city$yeartodate_pct_change,substring(robberies_city$yeartodate_pct_change,2))`%</h8> compared to the same time period in 2023, according to the latest data available from the New York Police Department.
...
ABC7's data team looked at the New York Police Department's data by neighborhood from 2020 through `r format(robberies_city$lastdate, "%B %d")`.
...
robberieslabel <- paste(sep="",
                     "<popuptitle>",
                     robberies_beat$yeartodate2024,
                     ifelse(robberies_beat$yeartodate2024==1,
                            " robbery", " robberies"),
                     ...
                     " residents. That's ",
                     case_when(robberies_beat$yeartodate2024>
                              robberies_beat$yeartodate2023 ~ "up from ",
                     robberies_beat$yeartodate2024<
                              robberies_beat$yeartodate2023 ~ "down from ",
                     TRUE ~ "the same as the "),
                     robberies_beat$yeartodate2023,
...
"</td>
				...
				<td>2022</td>
				<td>",
robberies_beat$total22,
"</td>
				<td>",
robberies_beat$rate22,
"</td>
			</tr>						<tr>
				<td>2023</td>
				<td>",
robberies_beat$total23,
"</td>
				<td>",
robberies_beat$rate23,
"</td>
			</tr>
						<tr>
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addTiles(urlTemplate = "https://pmtiles-raster.launch.studioshare.wds.io/styles/white-abc/{z}/{x}/{y}.png") %>%
