...
<bignumber>`r prettyNum(murders_city$yeartodate2023, big.mark=",")`<br></bignumber>
<p>Year To Date<br>Through `r format(murders_city$lastdate, "%B %d")`</p>
</div>
<div class="card" style="background-color:#99a0a5;">
<p>Homicides Last Year<br>
<bignumber>`r murders_city$yeartodate2022`<br></bignumber>
...
murderlabel <- paste(sep="",
                     ...
                     ifelse(murders_beat$yeartodate2023==1,
                            " homicide", " homicides"),
                     ...
                     " residents. That's ",
                     case_when(murders_beat$yeartodate2023>
                              murders_beat$yeartodate2022 ~ "up from ",
                     murders_beat$yeartodate2023<
                              murders_beat$yeartodate2022 ~ "down from ",
