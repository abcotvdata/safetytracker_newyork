...
<bignumber>`r prettyNum(sexassaults_city$yeartodate2021, big.mark=",")`<br></bignumber>
...
ABC7's data team looked at the New York Police Department's data by neighborhood from 2019 through `r format(sexassaults_city$lastdate, "%B %d")`.
