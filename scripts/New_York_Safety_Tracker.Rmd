...
One way to think about the danger: three years ago, the murder rate was <h8>`r murders_city$rate19`</h8> per 100,000 residents. That's only slightly more than half of the risk of dying in a vehicle crash: about 6.2 per 100,000 residents in 2020.

During the pandemic, a person's chance of being murdered in New York rose to almost the same likelihood of dying in a vehicle crash and is only now starting to subside. 
<br>
<br>
