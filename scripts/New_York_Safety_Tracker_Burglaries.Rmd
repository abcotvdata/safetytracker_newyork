...
<p>Burglaries This Year<br>
<bignumber>`r prettyNum(burglaries_city$yeartodate2024, big.mark=",")`<br></bignumber>
<p>Year To Date<br>Through `r format(burglaries_city$lastdate, "%B %d")`</p>
</div>
<div class="card" style="background-color:#99a0a5;">
<p>Burglaries Last Year<br>
<bignumber>`r prettyNum(burglaries_city$yeartodate2023, big.mark=",")`<br></bignumber>
...
<br>
Burglaries so far this year are trending <h8>`r ifelse(burglaries_city$yeartodate_pct_change>=0," up"," down")` `r ifelse(burglaries_city$yeartodate_pct_change>=0,burglaries_city$yeartodate_pct_change,substring(burglaries_city$yeartodate_pct_change,2))`%</h8> compared to the same time period in 2023, according to the latest data available from the New York Police Department.

However, the burglary rate over the last 12 months is <h8>`r case_when((burglaries_city$rate_last12-burglaries_city$rate_prior3years)>=0.25 ~ "up",
          (burglaries_city$rate_last12-burglaries_city$rate_prior3years)<=-0.25 ~ "down",
...
ABC7's data team looked at the New York Police Department's data by neighborhood from 2020 through `r format(burglaries_city$lastdate, "%B %d")`.
...
burglarieslabel <- paste(sep="",
                     "<popuptitle>",
                     burglaries_beat$yeartodate2024,
                     ifelse(burglaries_beat$yeartodate2024==1,
                            " burglary", " burglaries"),
                     ...
                     " residents. That's ",
                     case_when(burglaries_beat$yeartodate2024>
                              burglaries_beat$yeartodate2023 ~ "up from ",
                     burglaries_beat$yeartodate2024<
                              burglaries_beat$yeartodate2023 ~ "down from ",
                     TRUE ~ "the same as the "),
                     burglaries_beat$yeartodate2023,
...
"</td>
				...
				<td>2022</td>
				<td>",
burglaries_beat$total22,
"</td>
				<td>",
burglaries_beat$rate22,
"</td>
			</tr>
									<tr>
				<td>2023</td>
				<td>",
burglaries_beat$total23,
"</td>
				<td>",
burglaries_beat$rate23,
"</td>
			</tr>
						<tr>
