...
One way to think about the danger: three years ago, the murder rate was <h8>`r murders_city$rate19`</h8> per 100,000 residents. That's only slightly more than half of the risk of dying in a vehicle crash.
