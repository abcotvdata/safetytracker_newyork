...
ABC7's data team looked at the New York Police Department's data by neighborhood from 2019 through `r format(burglaries_city$lastdate, "%B %d")`.
...
burglarieslabel <- paste(sep="",
                     ...
                     ifelse(burglaries_beat$yeartodate2023==1,
                            " burglary", " burglaries"),
                     ...
                     " residents. That's ",
                     case_when(burglaries_beat$yeartodate2023>
                              burglaries_beat$yeartodate2022 ~ "up from ",
                     burglaries_beat$yeartodate2023<
                              burglaries_beat$yeartodate2022 ~ "down from ",
