...
h1.title {
  background-image: url('https://abcotvdata.github.io/safetytracker_newyork/skyline2.png');
...
<p>Homicides<br>
<bignumber>`r prettyNum(murders_city$yeartodate2022, big.mark=",")`<br></bignumber>
<p>Year To Date<br>Through `r format((Sys.Date() - 4), "%B %d")`</p>
</div>
<div class="card" style="background-color:#99a0a5;">
<p>Average Homicides<br>
<bignumber>`r murders_city$yeartodate2021`<br></bignumber>
...
<br>
Homicides so far this year are trending <h8>`r ifelse(murders_city$yeartodate_pct_change>=0," up"," down")` `r ifelse(murders_city$yeartodate_pct_change>=0,murders_city$yeartodate_pct_change,substring(murders_city$yeartodate_pct_change,2))`%</h8> compared to the same time period in 2021.

However, the murder rate over the last 12 months is<h8>`r ifelse((murders_city$last12mos-murders_city$avg_prior3years)>=0," up"," down")`</h8> compared to the annual average over the last three years, and the frequency of killings remains higher than it was before the pandemic.
...
One way to think about the danger: three years ago, the murder rate was <h8>`r murders_city$rate19`</h8> per 100,000 residents. That's only slightly higher than the risk of dying in a vehicle crash in New York City: about 2.9 per 100,000 residents in 2021.

During the pandemic, a person's chance of being murdered in New York rose to almost twice the likelihood of dying in a vehicle crash and is only now starting to fall. 
<br>
<br>
...
<iframe title="" aria-label="Dot Plot" id="datawrapper-chart-9SHHa" src="https://datawrapper.dwcdn.net/9SHHa/15/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="146" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
...
The map color-codes each neighborhood by the homicide rate over the last 12 months. Darker blue areas are neighborhoods where the murder rate is higher than the citywide rate.
...
murderlabel <- paste(sep="",
                     "<popuptitle>",
                     murders_beat$yeartodate2022,
                     ifelse(murders_beat$yeartodate2022==1,
                            " homicide", " homicides"),
                     ...
                     " people. That's ",
                     case_when(murders_beat$yeartodate2022>
                              murders_beat$yeartodate2021 ~ "up from ",
                     murders_beat$yeartodate2022<
                              murders_beat$yeartodate2021 ~ "down from ",
                     TRUE ~ "the same as the "),
                     murders_beat$yeartodate2021,
...
<iframe title="Homicides year by year in New York" aria-label="Column Chart" id="datawrapper-chart-zz6qQ" src="https://datawrapper.dwcdn.net/zz6qQ/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
  <br>
<br>

<!-- <subhead>What kinds of places do murders happen in New York</subhead> OPEN WORK TO REPLACE THIS CHART -->
...
<br>
<br>
<!-- <subhead>What time of day do murders happen?</subhead> OPEN WORK TO REPLACE THIS CHART -->
