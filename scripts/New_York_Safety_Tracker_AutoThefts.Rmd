...
ABC7's data team looked at the New York Police Department's data by neighborhood from 2019 through `r format(autothefts_city$lastdate, "%B %d")`.
...
autotheftslabel <- paste(sep="",
                     ...
                     ifelse(autothefts_beat$yeartodate2023==1,
                     ...
                     " residents. That's ",
                     case_when(autothefts_beat$yeartodate2023>
                              autothefts_beat$yeartodate2022 ~ "up from ",
                     autothefts_beat$yeartodate2023<
                              autothefts_beat$yeartodate2022 ~ "down from ",
