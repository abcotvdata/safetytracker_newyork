...
<bignumber>`r prettyNum(larcenies_city$yeartodate2021, big.mark=",")`<br></bignumber>
...
ABC7's data team looked at the New York Police Department's data by neighborhood from 2019 through `r format(larcenies_city$lastdate, "%B %d")`.
...
<table>      
      <tr>
			...
			<tr>
				<td>2019</td>
				<td>",
prettyNum(larcenies_beat$total19, big.mark=","),
"</td>
				<td>",
prettyNum(larcenies_beat$rate19, big.mark=","),
"</td>
			</tr>
			<tr>
				<td>2020</td>
...
<br>
<br>
<h2>Submit a tip or story idea to Eyewitness News</h2> 
Have a breaking news tip or an idea for a story we should cover? Send it to Eyewitness News using the form below. If attaching a video or photo, [url HREF=https://abc7ny.com/image-video-solicitation-and-rights-terms-of-use/5101040/ TARGET="_blank" REL=""]terms of use apply.[/url] [contest ID="1476ddf6-b69c-9afe-2613-3a0466586e07" /] 