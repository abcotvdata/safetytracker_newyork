...
<p>Assaults This Year<br>
<bignumber>`r prettyNum(assaults_city$yeartodate2024, big.mark=",")`<br></bignumber>
<p>Year To Date<br>Through `r format(assaults_city$lastdate, "%B %d")`</p>
</div>
<div class="card" style="background-color:#99a0a5;">
<p>Assaults Last Year<br>
<bignumber>`r prettyNum(assaults_city$yeartodate2023, big.mark=",")`<br></bignumber>
...
<br>
Felony assaults so far this year are trending <h8>`r ifelse(assaults_city$yeartodate_pct_change>=0," up"," down")` `r ifelse(assaults_city$yeartodate_pct_change>=0,assaults_city$yeartodate_pct_change,substring(assaults_city$yeartodate_pct_change,2))`%</h8> compared to the same time period in 2023, according to the latest data available from the New York Police Department.

However, the assault rate over the last 12 months is <h8>`r case_when((assaults_city$rate_last12-assaults_city$rate_prior3years)>=0.25 ~ "up",
          (assaults_city$rate_last12-assaults_city$rate_prior3years)<=-0.25 ~ "down",
          TRUE ~ "about the same ")`</h8> when compared to the annual average over the last three years, and the frequency of assaults remains higher than it was before the pandemic.
...
ABC7's data team looked at the New York Police Department's data by neighborhood from 2020 through `r format(assaults_city$lastdate, "%B %d")`.
...
assaultlabel <- paste(sep="",
                     "<popuptitle>",
                     assaults_beat$yeartodate2024,
                     ifelse(assaults_beat$yeartodate2024==1,
                            " assault", " assaults"),
                     ...
                     " residents. That's ",
                     case_when(assaults_beat$yeartodate2024>
                              assaults_beat$yeartodate2023 ~ "up from ",
                     assaults_beat$yeartodate2024<
                              assaults_beat$yeartodate2023 ~ "down from ",
                     TRUE ~ "the same as the "),
                     assaults_beat$yeartodate2023,
...
"</td>
				...
				<td>2022</td>
				<td>",
assaults_beat$total22,
"</td>
				<td>",
assaults_beat$rate22,
"</td>
			</tr>
									<tr>
				<td>2023</td>
				<td>",
assaults_beat$total23,
"</td>
				<td>",
assaults_beat$rate23,
"</td>
			</tr>
						<tr>
...
<iframe title="Felony assaults year by year in New York" aria-label="Column Chart" id="datawrapper-chart-lD4I4" src="https://datawrapper.dwcdn.net/lD4I4/5/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
