...
ABC7's data team looked at the New York Police Department's data by neighborhood from 2019 through `r format(assaults_city$lastdate, "%B %d")`.
...
assaultlabel <- paste(sep="",
                     ...
                     ifelse(assaults_beat$yeartodate2023==1,
                            " assault", " assaults"),
                     ...
                     " residents. That's ",
                     case_when(assaults_beat$yeartodate2023>
                              assaults_beat$yeartodate2022 ~ "up from ",
                     assaults_beat$yeartodate2023<
                              assaults_beat$yeartodate2022 ~ "down from ",
